...
class TimezonesList:
    """Class containing a list of timezones and providing methods to access them."""
    
    def getTimeZones(self):
        """
          Returns the list of available timezones.

          Each timezone is represented by a dictionary containing:
          - id: Unique identifier for the timezone.
          - timezone: The timezone code (e.g., 'ACDT').
          - name: Full name of the timezone (e.g., 'Australian Central Daylight Savings Time').
          - UTCOffset: The UTC offset (e.g., '+10:30').

          :return: List of dictionaries representing timezones.
          """
        return [
               {
                 "id": 1,
